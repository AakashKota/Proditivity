  ...
  return (<>
    ...
    <div className='for_students_about'>
          <div className='mission-text'>
            ...
            <p className='our'>Our<span className='vision'>Mission</span></p>
    ...
    <div className='for_students_about'>
      <div className='mission_text'>
        <p className='our'>Our <span className='vision'>Vision</span></p> 
   ...
   {/* <img src="https://i.ibb.co/GxGr65c/vision.png" alt="vision" border="0" className='mission-image'/> */}
    ...
    <div className='poditivity'>
      <div className='heading_about'> <h2>We are Poditivity</h2></div>
